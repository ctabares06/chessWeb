  ...
  return (
    <div>
      <form action="" onSubmit={sendForm}>
        ...
        <span>white</span>
        <input type="radio" name="side" checked={side === Sides.white} value={Sides.white} onChange={handleSide} />
        <span>black</span>
        <input type="radio" name="side" checked={side === Sides.black} value={Sides.black} onChange={handleSide} />
